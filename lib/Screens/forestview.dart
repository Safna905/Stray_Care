...
class ForestViewPage extends StatelessWidget {
   ForestViewPage({Key? key}) : super(key: key);

  var flag = 0;
  Future View() async {
    var data = {"Type": "wild"};
    var response =
    await post(Uri.parse('${Con.url}forestview.php'), body: data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 112.h,
        title: text('Wild Animals', 20.sp, Colors.white, FontWeight.w600),
        actions: [
          Padding(
