...
class PoliceView extends StatelessWidget {
   PoliceView({Key? key}) : super(key: key);

  var flag = 0;
  Future View() async {
    var data = {"Type": "abused"};
    var response =
    await post(Uri.parse('${Con.url}policeview.php'), body: data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 112.h,
        title: text('Abused Animals', 20.sp, Colors.white, FontWeight.w600),
        actions: [
          Padding(
