...
class Vetview extends StatelessWidget {
  Vetview({Key? key}) : super(key: key);

  var flag = 0;
  Future View() async {
    var data = {"Type": "injured"};
    var response =
    await post(Uri.parse('${Con.url}vetview.php'), body: data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 112.h,
        title: text('Injured Animals', 20.sp, Colors.white, FontWeight.w600),
        actions: [
          Padding(
